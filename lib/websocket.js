...
function initAsClient(websocket, address, protocols, options) {
  ...
  req.on('error', (err) => {
    ...
    console.log(websocket._isServer ? 'server' : 'client', 'close on req error');
    websocket.emitClose();
  });
...
function receiverOnErrorOrFinish() {
  console.log(this[kWebSocket]._isServer ? 'server' : 'client', 'close on receiver error or finish');
...
function socketOnClose() {
  ...
  if (
    ...
    console.log(websocket._isServer ? 'server' : 'client', 'close on socket close');
    websocket.emitClose();
  } else {
